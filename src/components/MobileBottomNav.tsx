...
const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  const tabs = [
    { id: 'overview', label: language === 'en' ? 'Overview' : 'Ikhtisar', icon: Activity },
    { id: 'early-alerts', label: language === 'en' ? 'Alerts' : 'Peringatan', icon: BellRing },
    { id: 'ai-insights', label: language === 'en' ? 'Copilot' : 'Kopilot', icon: Bot },
    { id: 'weather', label: language === 'en' ? 'Weather' : 'Cuaca', icon: Cloud },
  ];
