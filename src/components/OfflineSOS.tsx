...
const translations = {
  ...
  id: {
    title: "QR SOS Offline",
    desc: "Hasilkan profil darurat yang dapat dipindai. Bekerja tanpa internet.",
    name: "Nama Lengkap",
    blood: "Golongan Darah",
    medical: "Kondisi Medis / Alergi",
    contact: "Rute Kontak Darurat",
    generate: "Hasilkan QR Darurat",
    success: "Profil Disimpan Offline. QR Siap.",
    location: "Mengambil GPS Akurasi Tinggi...",
    locationDone: "Koordinat GPS Terkunci",
    scanDesc: "Tunjukkan ini kepada petugas penyelamat. Mereka dapat memindainya tanpa internet untuk mendapatkan profil medis dan koordinat tepat Anda."
  }
};
